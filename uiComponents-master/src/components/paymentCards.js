...
export default class PaymentCards extends React.Component {
  ...
  submitTransaction = () => {
    ...
    ReactGA.event({
      ...
      action: 'Sent',
      label: 'User has sent HP on the platform',
  ...
  render() {
    ...
    return (
      ...
      <h1
        ...
        > {'Send ' +this.state.transactionAmount+ ' HP to '+ this.state.recipient}
       </h1>
          ...
          <div style={contentStyle}>
            ...
            <div style={{marginTop: 12,}}>
              ...
              <RaisedButton
                label={
                  // this.state.nextMsg
                  this.state.stepIndex === 2 ? "Send" : "Next"
                }
                disabled={ !this.props.preLoadUser && (this.state.colors.indexOf(this.state.recipient) < 0)}
